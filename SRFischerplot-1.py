...
Developer: Daming Yang. 
E-mail: damingyang@sohu.com. 
Software Require: Python 3.0 language pack, Python library Xlrd, Python library Xlsxwriter.
Program Language: Python 3.0. 
Program Size: 4.48 KB. 
Purpose: constructing SR-Fischer plots using sedimentary-cycle data in batches.
'''
...
class WorkBook(object):
    ...
    def get_data(self, path):
        ...
        cols_4 = Data_sheet.col_values(0)
        del cols_4[0]
        cols_b = Data_sheet.col_values(1)
        del cols_b[0]
        return cols_4, cols_b
